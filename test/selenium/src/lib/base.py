...
class CustomAttributeDate(DatePicker, AbstractCustomAttribute):
  """Implementation of abstarct class AbstractCustomAttribute
  for date custom attribute."""

  def __init__(self, driver, date_picker_locator, field_locator):
    super(CustomAttributeDate, self).__init__(driver, date_picker_locator,
                                              field_locator)

  def set_value(self):
    """Set value of Date custom attribute."""
    self.select_rand_day_in_current_month()
