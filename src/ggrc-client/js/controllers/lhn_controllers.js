...
can.Control.extend({
  ...
  defaults: {
    list_view: GGRC.stache_path + '/base_objects/search_result.stache',
    actions_view: GGRC.stache_path + '/base_objects/search_actions.stache',
  ...
  display: function () {
    let templatePath = GGRC.stache_path + this.element.data('template');
    ...
    $.ajax({
      ...
      this.element.html(can.stache(view)(lhnPrefs));
    });
