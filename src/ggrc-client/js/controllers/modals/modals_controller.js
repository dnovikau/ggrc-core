...
export default can.Control({
  ...
  defaults: {
    preload_view: GGRC.stache_path + '/dashboard/modal_preload.stache',
    header_view: GGRC.stache_path + '/modals/modal_header.stache',
    custom_attributes_view:
    GGRC.stache_path + '/custom_attributes/modal_content.stache',
    button_view: null,
